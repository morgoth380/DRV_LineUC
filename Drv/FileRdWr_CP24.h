...
#define SIZE_FIRMWARE_PULT_OP24B  0x10000       // Размер файла прошивки пульта OP24S (в словах) - предварительно сделаем 256 кБ на пульт
#define SIZE_FOP_GZ               0x18000       // Размер ФОПа архивированный (в словах)
...
#define    N_Files          27  // Колич файлов
/*============================================================================*/
...
////    u32                 DateTime        ;   // Дата и врмя события
////    u16                 NumAddPrm       ;   // Номер дополнительного параметра
////    type_avarHltRec     avarHltRec[65];     // Записи со значениями параметров
////    u16                 FileCRC         ;   // Контрольная сумма на файл
////}type_hltPrmJrn;
/////*============================================================================*/
////typedef struct {
...
////    u16     SzUst;
////    u16     rsrvd[61];
////    u16     MicroProg[SZ_MICROPROG_DATA];
////}ustSet_type;
////
////#define SZ_OF_PAGE  528UL
////
////typedef union {
////    ustSet_type UstMicro;
////    u16 Mas[(sizeof(ustSet_type) / SZ_OF_PAGE + 1) * SZ_OF_PAGE];      //Выравнивание по границе 528 байт
////}file_microprog_type;
////typedef struct {
//////type_descriptorPrm  DescrPrm;                             // Структура описателя параметров
////        //u16                 fileDescrPrm[0x10000];          // Файл описателя параметров 2x64 кБайт
////        //расширил размер фоп для многоязычности
////        u16                 fileDescrPrm[0x80000];          // Файл описателя параметров 2x256 кБайт
////        //u16                 rezmem[528UL*256 - 0x10000];    // Резервное место для выравнивания на границу блока памяти
////        //изменил выравнивание для многоязычности для многоязычности
////        //u16                 rezmem[528UL*512 - 0x40000];    // Резервное место для выравнивания на границу блока памяти
////        u16                 filePultBin[0x40000];
////        u16                 rezmem3[528UL*497 - 0x40000];    // Резервное место для выравнивания на границу блока памяти
////        type_hltPrmJrn      fileHltPrmJrn;                  // Журнал аварий 1000 записей
////        //u16                 resMem[0x50000 - 32*32*2 - 0x10000]; // Выравнивание на 1 МБайт
////        u16                 rezmem1[528 - (sizeof(type_hltPrmJrn) % SZ_OF_PAGE)];
////        u16                 fileProg[0x7fe0];               // Файл с программой 512 кБайт
////        u16                 rezmem2[528 - ((sizeof(u16) * 0x7fe0) % SZ_OF_PAGE)];
////        file_microprog_type fileMicroProg1;
////        file_microprog_type fileMicroProg2;
////        file_microprog_type fileMicroProg3;
////}spfl_type;
...
////}FATtable_type;
////
////#define    N_Files          23  // Колич файлов
/////*============================================================================*/
//////          Области хранения файла для FAT таблицы
////#define     FILE_In_ERR         0   // Ошибка такого файла нет
////#define     FILE_In_Flash       1   // Файл лежит в FLASH памяти
