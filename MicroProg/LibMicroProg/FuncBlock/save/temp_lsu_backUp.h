...
u16  Pnt_Nfunc;
    ...
    u16  Pnt_Freeze2;                      //14  Freeze2
    u16  Pnt_Freeze3;                      //15  Freeze3
    u16  Pnt_F_PU;                         //16  Freeze3
    u16  Pnt_Reset;                        //17  Reset
    u16  Pnt_EquRV;                        //18  EquRV
    u16  Pnt_Zero;                         //19  Zero
    u16  Pnt_Dwn;                          //20  Dwn
    u16  Pnt_Up;                           //21  Up
    u16  Pnt_Status;                       //22  Status
    u16  Pnt_Out;                          //23  Out
    u16  Pnt_End;
}FuncTEMP_LSU_type;
...
u16 *FuncTEMP_LSU_1(FuncTEMP_LSU_type *progPnt, u32 ramPnt)
{
    ...
    tempFreeze      =    (testBitMicro(ramPnt, progPnt->Pnt_Freeze) || testBitMicro(ramPnt, progPnt->Pnt_Freeze2)
                          || testBitMicro(ramPnt, progPnt->Pnt_Freeze3));
...
const char TblFuncTEMP_LSU_1[23]={
        ...
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //14  Freeze2
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //15  Freeze3
        S32_PIN_TYPE | INPUT_PIN_MODE,     //16  F_PU
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //17  Reset
        BIT_PIN_TYPE | OUTPUT_PIN_MODE,    //18  EquRV
        BIT_PIN_TYPE | OUTPUT_PIN_MODE,    //19  Zero
        BIT_PIN_TYPE | OUTPUT_PIN_MODE,    //20  Dwn
        BIT_PIN_TYPE | OUTPUT_PIN_MODE,    //21  Up
        S16_PIN_TYPE | OUTPUT_PIN_MODE,    //22  Status
        S32_PIN_TYPE | OUTPUT_PIN_MODE     //23  Out
};
#endif
//********************************************************
#ifdef    GET_FUNC_OPIS
