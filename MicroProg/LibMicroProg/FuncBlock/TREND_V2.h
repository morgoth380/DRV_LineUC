...
typedef struct{
    ...
    u16  Pnt_State;
    //u16  Pnt_nvState;
    u16  Pnt_In[8];                        //1 - 8  In0 - In7
    u16  Pnt_sel;                          //9  sel
    u16  Pnt_Diskr;                        //10  Diskr
    u16  Pnt_Timer;                        //11  Timer
    u16  Pnt_Type;                         //12  Type
    u16  Pnt_UnixTime;                     //13  UnixTime
    u16  Pnt_PWM_ON;                       //14  PWM_ON
    u16  Pnt_FM_Mutex;                     //15  FM_Mutex
    u16  Pnt_TimeFormat;                   //16  TimeFormat
    u16  Pnt_T_write;                      //17  T_write
    u16  Pnt_TrndWarning;                  //18  TrndWarning
    u16  Pnt_End;
}FuncTREND_V2_type;
//********************************************************
u16 *FuncTREND_V2_1(FuncTREND_V2_type *progPnt, u32 ramPnt)
{
    ...
    tmpVal = load_s32(ramPnt, progPnt->Pnt_In[sel]);        //Записываемая величина
...
const char TblFuncTREND_V2_1[18]={
        ...
        S16_PIN_TYPE | INPUT_PIN_MODE,     //9  sel
        S16_PIN_TYPE | INPUT_PIN_MODE,     //10  Diskr
        S16_PIN_TYPE | INPUT_PIN_MODE,     //11  Timer
        S16_PIN_TYPE | INPUT_PIN_MODE,     //12  Type
		S32_PIN_TYPE | INPUT_PIN_MODE,     //13  UnixTime
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //14  PWM_ON
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //15  FM_Mutex
        S16_PIN_TYPE | OUTPUT_PIN_MODE,    //16  TimeFormat
        S16_PIN_TYPE | OUTPUT_PIN_MODE,    //17  T_write
        BIT_PIN_TYPE | OUTPUT_PIN_MODE     //18  TrndWarning
};
#endif
//********************************************************
#ifdef    GET_FUNC_OPIS
//SymbolName,  Prefix,  typePin, FuncPnt, SizeOfState, SizeOfNvState, ExeLogicBlock
OpisFuncBlock("TREND_V2", "DA", TblFuncTREND_V2_1, FuncTREND_V2_1, sizeof(TblFuncTREND_V2_1), sizeof(TREND_State_type), 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
    (pFuncMicro_type)FuncTREND_V2_1,
#endif
//********************************************************
