...
typedef struct{
    ...
    u16  Pnt_StopAPV;                      //10  StopAPV
    u16  Pnt_StopOut;                      //11  StopOut
    u16  Pnt_End;
}FuncSTOP_type;
//********************************************************
u16 *FuncSTOP_1(FuncSTOP_type *progPnt, u32 ramPnt)
{
    ...
    Stop = (testBitMicro(ramPnt, progPnt->Pnt_StopNet)   | testBitMicro(ramPnt, progPnt->Pnt_StopNetFail) |
        ...
        testBitMicro(ramPnt, progPnt->Pnt_StopRun)   | testBitMicro(ramPnt, progPnt->Pnt_StopSleep) |
...
const char TblFuncSTOP_1[11]={
        ...
        BIT_PIN_TYPE | OUTPUT_PIN_MODE,    //10  StopAPV
        BIT_PIN_TYPE | OUTPUT_PIN_MODE     //11  StopOut
};
#endif
//********************************************************
#ifdef    GET_FUNC_OPIS
//SymbolName,  Prefix,  typePin, FuncPnt, SizeOfState, SizeOfNvState, ExeLogicBlock
OpisFuncBlock("STOP", "DD", TblFuncSTOP_1, FuncSTOP_1, sizeof(TblFuncSTOP_1), 0, 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
