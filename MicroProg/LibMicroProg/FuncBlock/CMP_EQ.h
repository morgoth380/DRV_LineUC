...
//      s16              s16              s16
//********************************************************
u16 *FuncCMP_EQ_1(FuncCMP_EQ_type *progPnt, u32 ramPnt)
{
    s16     A, B;
...
OpisFuncBlock("CMP_EQ", "DA", TblFuncCMP_EQ_1, FuncCMP_EQ_1, sizeof(TblFuncCMP_EQ_1), 0, 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
    (pFuncMicro_type)FuncCMP_EQ_1,
#endif
//********************************************************
...
#ifdef    GET_FUNC_CODE
//********************************************************
u16 *FuncCMP_EQ_2(FuncCMP_EQ_type *progPnt, u32 ramPnt)
{
    s32     A, B;
...
#ifdef    GET_FUNC_OPIS
//SymbolName,  Prefix,  typePin, FuncPnt, sizeofState, sizeofNVState, ExeLogicBlock
OpisFuncBlock("CMP_EQ", "DA", TblFuncCMP_EQ_2, FuncCMP_EQ_2, sizeof(TblFuncCMP_EQ_2), 0, 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
    (pFuncMicro_type)FuncCMP_EQ_2,
#endif
//********************************************************
