...
//********************************************************
u16 *FuncOR_2_1(FuncOR_2_type *progPnt, u32 ramPnt)
{
    s16     Arg1, Arg2;
...
OpisFuncBlock("OR-2", "DD", TblFuncOR_2_1, FuncOR_2_1, sizeof(TblFuncOR_2_1), 0, 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
    (pFuncMicro_type)FuncOR_2_1,
#endif
//********************************************************
