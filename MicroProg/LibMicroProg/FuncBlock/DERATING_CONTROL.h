...
typedef struct{
    ...
    u16  Pnt_FpwmStepDR;                   //11  FpwmStepDR
    u16  Pnt_Reserved12;                   //12  Reserved12
...
const char TblFuncDERATING_CONTROL_1[15]={
        ...
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //4  AlarmOVL
        ...
        S16_PIN_TYPE | INPUT_PIN_MODE,     //11  FpwmStepDR
        S16_PIN_TYPE | INPUT_PIN_MODE,     //12  Reserved12
        S16_PIN_TYPE | INPUT_PIN_MODE,     //13  ModeDR
        S16_PIN_TYPE | OUTPUT_PIN_MODE,    //14  TekFpwm
        BIT_PIN_TYPE | OUTPUT_PIN_MODE     //15  WarnWorkDR
};
#endif
//********************************************************
#ifdef    GET_FUNC_OPIS
