...
u16 *FuncADD_2(FuncADD_type *progPnt, u32 ramPnt)
{
    ...
    Arg1 = load_s32(ramPnt, progPnt->Pnt_Arg_1);
    Arg2 = load_s32(ramPnt, progPnt->Pnt_Arg_2);
    Arg1 -= Arg2;
    if(Arg1 > 0x7FFFFFFF)   Arg1 = 0x7FFFFFFF;
    save_s32(ramPnt, progPnt->Pnt_Arg_3, (s32)Arg1);
    return &progPnt->Pnt_End;
};
#endif
//********************************************************
