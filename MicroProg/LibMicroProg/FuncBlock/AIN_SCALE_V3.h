...
//********************************************************
u16 *FuncAIN_SCALE_V3_1(FuncAIN_SCALE_V3_type *progPnt, u32 ramPnt)
{
...
const char TblFuncAIN_SCALE_V3_1[32]={
        ...
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //9  HistMin
        ...
        BIT_PIN_TYPE | INPUT_PIN_MODE,     //21  PwmOn
        ...
        S16_PIN_TYPE | OUTPUT_PIN_MODE     //32  StateCode
};
#endif
//********************************************************
#ifdef    GET_FUNC_OPIS
//SymbolName,  Prefix,  typePin, FuncPnt, SizeOfState, SizeOfNvState, ExeLogicBlock
OpisFuncBlock("AIN_SCALE_V3", "DA", TblFuncAIN_SCALE_V3_1, FuncAIN_SCALE_V3_1, sizeof(TblFuncAIN_SCALE_V3_1), sizeof(AINSCALE3_State_type), 0, 1),
#endif
//********************************************************
#ifdef    GET_FUNC_PNT
    (pFuncMicro_type)FuncAIN_SCALE_V3_1,
#endif
//********************************************************
