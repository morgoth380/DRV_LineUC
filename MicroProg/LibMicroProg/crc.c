...
unsigned short Crc_test(unsigned char *Bff, unsigned short szBff)
{
    unsigned short  tmp,  crc;
...
#endif  //CHAR_BIT
//**************************************************************************
//      Подсчет контрольной суммы порциями данных по 8 бит
//**************************************************************************
...
//**************************************************************************
//      Подсчет контрольной суммы порциями данных по 16 бит
//**************************************************************************
...
/*
int __byte(int *Bff, unsigned int i)
{
    char    *bPnt;
    bPnt = Bff;
    return  (int)(bPnt[i]);
